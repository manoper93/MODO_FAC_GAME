...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBZVQguSAES0A5EO4f7+08uKoEQYWvY6OIvemoCcIeIS5k3rSbsC8lUavuovOTd8XzaOLiAEik9t+GGdMqc=
::YB416Ek+ZW8=
::
::
...
echo MODO FACULDADE = [s]-(SIM) ou [n]-(NAO) ou [r]-(RECUPERAR BASICO):
set /p escolha=
